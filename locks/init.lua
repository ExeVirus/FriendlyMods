...
function locks:lock_handle_input(pos, formname, fields, player)
    ...
    if (fields.locks_sent_lock_command == "/help") then
        ...
        end -- lua is not the most intuitive language here....
        return ;
    end -- of /help
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
    ...
    if formname:find("locks_config:") then
        -- search if formname contains locks
    ...
    elseif formname:find("locks_authorize:") then
        ...
        elseif fields.enter_password then
            --if the user clicks the "Enter Password" button in the "access denied" formspec
